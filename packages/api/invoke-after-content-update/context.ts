...
import { ContentUpdateContext } from "./types";
...
export const createContext = () => {
    return new ContextPlugin<ContentUpdateContext>(async context =>{
        /**
         * Subscribe to onEntryAfterUpdate to invoke lambda function
         */
        context.cms.onEntryAfterUpdate.subscribe(async ({ model, entry }) => {
            try {
                ...
                throw new Error("ContentAfterUpdate::Error invoking lambda function: " + e);
            }
        })
    }
);}