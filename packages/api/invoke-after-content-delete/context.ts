...
import { ContentDeleteContext } from "./types";
...
export const createContext = () => {
    return new ContextPlugin<ContentDeleteContext>(async context =>{
        /**
        ...
        context.cms.onEntryAfterDelete.subscribe(async ({ model, entry }) => {
            try {
                ...
                throw new Error("ContentAfterDelete::Error invoking lambda function: " + e);
            }
        })
    }
);}